...
- Make sure you agree to contribute your code under `graphomics` [license](https://github.com/Nico-Curti/graphomics/blob/main/LICENSE)
...
3. Fork [this](https://github.com/Nico-Curti/graphomics) repository.
...
10. Submit a Pull Request into `dev` (following the pull request [template](https://github.com/Nico-Curti/graphomics/blob/main/.github/PULL_REQUEST_TEMPLATE/PULL_REQUEST_TEMPLATE.md))
