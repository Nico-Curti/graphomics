...
- Make sure you agree to contribute your code under `graphomics` license_.

- If you are going to fix a bug, check that it's still exists and that you are working with the latest version of `graphomics` library.
...
10. Submit a Pull Request into `dev` (following the pull request template_).
...
2. Make sure you got credits at the end of merge: we have a lot of project to follow and we may forget to add your name to the list of authors. Please, do not hesitate to remind us!


.. _issue: https://github.com/Nico-Curti/graphomics/blob/main/.github/ISSUE_TEMPLATE/ISSUE_TEMPLATE.md
.. _`pull request`: https://github.com/Nico-Curti/graphomics/blob/main/.github/PULL_REQUEST_TEMPLATE/PULL_REQUEST_TEMPLATE.md
.. _license: https://github.com/Nico-Curti/graphomics/blob/main/LICENSE
.. _this: https://github.com/Nico-Curti/graphomics
.. _template: https://github.com/Nico-Curti/graphomics/blob/main/.github/PULL_REQUEST_TEMPLATE/PULL_REQUEST_TEMPLATE.md
