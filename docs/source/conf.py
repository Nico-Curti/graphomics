...
project = 'pygraphomics - Graphomics feature extraction in Python'
...
latex_documents = [('index', 'graphomics.tex', u'pygraphomics - Graphomics feature extraction in Python', u'Nico Curti', 'manual'),]
