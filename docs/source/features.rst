...
The `graphomics` package includes a set of medical imaging features
...
The major part of the graphomic features depends on the structure of the
skeleton graph and therefore could vary according to the graph weighing.
In the `graphomics` package we implement a series of ready-to-use algorithms
for the networkx weighing according to different criteria.
